...
/* ./.libs/lt-fftwf-wisdom.c - temporary wrapper executable for .libs/fftwf-wisdom
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-15

   The fftwf-wisdom program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/d/Code/SPDC_gcc/fftw-3.3.10/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/d/Code/SPDC_gcc/fftw-3.3.10/.libs:";
const char * TARGET_PROGRAM_NAME = "fftwf-wisdom"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# fftwf-wisdom - temporary wrapper script for .libs/fftwf-wisdom\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-15\n", f);
  fputs ("#\n", f);
  fputs ("# The fftwf-wisdom program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../libfftw3f.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"fftwf-wisdom:fftwf-wisdom:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6 Debian-2.4.6-15\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fftwf-wisdom:fftwf-wisdom:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fftwf-wisdom:fftwf-wisdom:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
  ...
  fputs ("    PATH=/d/Code/SPDC_gcc/fftw-3.3.10/.libs:$PATH\n", f);
  fputs ("\n", f);
